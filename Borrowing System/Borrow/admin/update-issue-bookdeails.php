...
<head>
    ...
    <title>Borrowing Management System | Issued Item Details</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">รายละเอียดการยืม</h4>
...
<div class="form-group">
<label>รหัสครุภัณ์ ISBN :</label>
<?php echo htmlentities($result->ISBNNumber);?>
</div>

<div class="form-group">
<label>วันที่-ยืม :</label>
<?php echo htmlentities($result->IssuesDate);?>
</div>


<div class="form-group">
<label>วันที่-คืน :</label>
...
<button type="submit" name="return" id="submit" class="btn btn-info">คืนอุปกรณ์ </button>
