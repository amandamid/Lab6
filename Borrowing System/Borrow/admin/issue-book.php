...
<head>
    ...
    <title>Borrowing Management System | Issue a new Item</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">การยืมอุปกรณ์</h4>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">ยืม </button>
