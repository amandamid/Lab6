...
<head>
    ...
    <title>Borrowing Management System | Manage Issued Item</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">ประวัติการยืม-คืน</h4>
    </div>
     <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>ชื่อUser-ผู้ยืม</th>
                                            <th>ชื่อ-อุปกรณ์</th>
                                            <th>รหัสครุภัณฑ์-ISBN </th>
                                            <th>วันที่-ยืม</th>
                                            <th>วันที่-คืน</th>
                                            <th>สถานะ</th>
                                        </tr>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> แก้ไข</button> 
